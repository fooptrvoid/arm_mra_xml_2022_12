...
<xsl:template name="generate_footer">
  ...
  <p class="copyconf">Copyright &#169; 2010-2022 Arm Limited or its affiliates. All rights reserved. This document is Non-Confidential.</p>
</xsl:template>
...
<xsl:template name="offset_accessibility">
  ...
  <xsl:choose>
    <xsl:when test="count($reg_address/reg_access/reg_access_state) = 1 and $reg_address/reg_access/reg_access_state/reg_access_level">
      <p><xsl:value-of select="$reg_address/reg_access/reg_access_state/reg_access_level"/><xsl:text>, accesses to this interface </xsl:text><xsl:apply-templates select="$reg_address/reg_access/reg_access_state/reg_access_type"/>.</p>
    </xsl:when>
    ...
    <xsl:otherwise><p>Accesses to this interface <xsl:apply-templates select="$reg_address/reg_access/reg_access_state/reg_access_type"/>.</p></xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template match="field_access_level">
    <xsl:choose>
        ...
        <!-- ALSO NEED TO ADD NESTING CONDITION HERE -->
            <xsl:value-of select="field_access_level"/>, access is:
        </xsl:otherwise>
    </xsl:choose>
</xsl:template>
